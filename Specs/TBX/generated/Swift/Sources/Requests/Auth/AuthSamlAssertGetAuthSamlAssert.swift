...
extension TBX.Auth {
    ...
    public enum AuthSamlAssertGetAuthSamlAssert {
        ...
        public static let service = APIService<Response>(id: "auth.samlAssert__get_auth_saml_assert", tag: "auth", method: "GET", path: "/auth/saml/assert", hasBody: false, securityRequirements: [])
