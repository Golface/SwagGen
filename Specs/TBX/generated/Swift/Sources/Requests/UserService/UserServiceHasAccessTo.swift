...
extension TBX.UserService {
    ...
    public enum UserServiceHasAccessTo {
        ...
        public static let service = APIService<Response>(id: "UserService.hasAccessTo", tag: "UserService", method: "GET", path: "/UserServices/{customer}/hasAccessTo", hasBody: false, securityRequirements: [])
