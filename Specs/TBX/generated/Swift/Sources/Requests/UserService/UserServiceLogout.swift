...
extension TBX.UserService {
    ...
    public enum UserServiceLogout {
        ...
        public static let service = APIService<Response>(id: "UserService.logout", tag: "UserService", method: "DELETE", path: "/UserServices/device/{device}", hasBody: false, securityRequirements: [])
