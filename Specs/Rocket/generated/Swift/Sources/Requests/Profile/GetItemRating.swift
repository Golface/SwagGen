...
extension Rocket.Profile {
    ...
    public enum GetItemRating {
        ...
        public static let service = APIService<Response>(id: "getItemRating", tag: "profile", method: "GET", path: "/account/profile/ratings/{itemId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "profileAuth", scopes: ["Catalog"])])
