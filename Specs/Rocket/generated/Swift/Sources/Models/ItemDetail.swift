 ...
 */
    ...
    public init(
        ...
        credits: [Credit]? = nil, 
        customMetadata: [ItemCustomMetadata]? = nil, 
        description: String? = nil, 
        distributor: String? = nil, 
        episodeName: String? = nil, 
        episodes: ItemList? = nil, 
        eventDate: DateTime? = nil, 
        genrePaths: [String]? = nil, 
        location: String? = nil, 
        season: ItemDetail? = nil, 
        seasons: ItemList? = nil, 
        show: ItemDetail? = nil, 
        totalUserRatings: Double? = nil, 
        trailers: [ItemSummary]? = nil, 
        venue: String? = nil
    ) {
